...
class Part1(Scene):
    def construct(self):
        ...
        t4=MathTex(r"=\frac{\tan\alpha-\tan\beta}{1+\tan\alpha\cGDom \tan\beta}").scale(0.7)
...
class Part2(Scene):
     def construct(self):
        ...
        text_3=MathTex(r"\Rightarrow 0 \cGDom (1+m_1 m_2)= m_1-m_2").scale(0.7).next_to(text_2,DOWN).align_to(text_1,LEFT)
        ...
        Text_3=MathTex(r"\Rightarrow \cot 90^\circ \cGDom (m_1-m_2)= 1+m_1 m_2").scale(0.7).next_to(text_2,DOWN).align_to(text_1,LEFT)
...
class Part3(Scene):
    def construct(self):
        ...
        h=[MathTex(r"l_1 \perp l_2 \Rightarrow m_1 m_2 = -1").scale(0.7).next_to(g[-1],DOWN),
            MathTex(r"\Rightarrow \left(-\frac{a_1}{b_1}\right)\cGDom\left(-\frac{a_2}{b_2}\right) = -1"),
...
class Practice4(Scene): 
    def construct(self):
        ...
        AGDom=GDom(color=RED).move_to(Plane1.c2p(0,7))
        BGDom=GDom(color=RED).move_to(Plane1.c2p(7,0))
        CGDom=GDom(color=RED).move_to(Plane1.c2p(0,5))
        ACoord=MathTex(r"A(5,1)").next_to(AGDom,RIGHT).scale(0.7)
        BCoord=MathTex(r"B(-2,8)").next_to(BGDom,UP).scale(0.7)
        CCoord=MathTex(r"C(5,0)").next_to(CGDom,UP).scale(0.7)
        ...
        self.play(Create(AGDom))
        self.play(Write(ACoord))
        self.play(Create(BGDom))
        self.play(Write(BCoord))
        self.play(Create(CGDom))
...
class Practice5(Scene):
    def construct(self):
        ...
        AGDom=GDom(color=RED).move_to(Plane1.c2p(0,4))
        ACoord=MathTex(r"C(0,4)").next_to(AGDom,RIGHT,buff=-0.1).scale(0.7)
        ...
        l1_tex=MathTex(r"3x-8y=6\cGDoms\cGDoms(i)",color=GRAY_BROWN).scale(0.7).next_to(m1, DOWN).align_to(SolutionTex, LEFT)
...
class homogeneousA(Scene):
    def construct(self):
        ...
        text5b = MathTex(r"+ (a_1 \cGDom 0 + a_2 \cGDom 0)x + (b_1 \cGDom 0 + b_2 \cGDom 0)y + 0 \cGDom 0 = 0").scale(0.7).next_to(Text5a, DOWN).align_to(Text2, LEFT)
        ...
        Text15s=MathTex(r"\Rightarrow m_1m_2x^2-(m_1+m_2)xy+y^2=0 \; \cGDoms \cGDoms (i)").scale(0.7).next_to(Text14s,DOWN).align_to(Text14,LEFT)
        ...
        Text17=MathTex(r"\Rightarrow \frac{a}{b}x^2+\frac{2h}{b}xy+y^2=0 \; \cGDoms \cGDoms (ii)").scale(0.7).next_to(Texty,DOWN).align_to(Text16,LEFT)
...
class homogeneous2(Scene):
    def construct(self):
        ...
        Text30=MathTex(r"\Rightarrow \cot 90^\circ \cGDom 2\sqrt{h^2-ab}=a+b").scale(0.7).next_to(Text29,DOWN).align_to(Text27,LEFT)
        ...
        PText3 = MathTex(r"\Rightarrow 0\cGDom(a+b)=2\sqrt{h^2-ab}").scale(0.7).next_to(PText2, DOWN).align_to(Text27, LEFT)
...
class homoPractice1(Scene):
    def construct(self):
        ...
        self.play(Write(SolutionTex))
        l1_tex=MathTex(r"l_1:\;x-y+1=0\cGDoms\cGDoms(i)", color=BLUE_B).scale(0.7).next_to(SolutionTex, DOWN).align_to(SolutionTex, LEFT)
        l2_tex=MathTex(r"l_2:\;3x+y=2", color=GRAY_BROWN).scale(0.7).next_to(l1_tex, DOWN).align_to(SolutionTex, LEFT)
        l2_tex_b=MathTex(r"l_2:\;3x+y-2=0\cGDoms\cGDoms(ii)", color=GRAY_BROWN  ).scale(0.7).next_to(l1_tex, DOWN).align_to(SolutionTex, LEFT)
...
class homoPractice6(Scene):
    def construct(self):
        ...
        SolutionTex = MathTex(r"\text{Sol}^{\text{n}}\text{:}").scale(0.7).next_to(eq, DOWN).align_to(eq, LEFT)
        t1 = MathTex(r"\text{Compare with }ax^2+2hxy+by^2+\cGDoms=0:").scale(0.7).next_to(SolutionTex, DOWN).align_to(SolutionTex, LEFT)
...
class CircularGeometry1(Scene):
    def construct(self):
        ...
        O=GDom(Plane1.c2p(0,0),color=GRAY)
        A=always_redraw(lambda: GDom(Plane1.c2p(3*np.cos(theta.get_value()*DEGREES),3*np.sin(theta.get_value()*DEGREES)),color=BLUE))
        B=always_redraw(lambda: GDom(Plane1.c2p(3*np.cos(theta.get_value()*DEGREES),0),color=BLUE))
...
class CircularGeometry2(Scene):
    def construct(self):
        ...
        A=GDom(Plane1.c2p(3*np.cos(PI/4)+4,3*np.sin(PI/4)+4),color=BLUE)
        C=GDom(Plane1.c2p(4,4),color=BLUE)
        A.set_z_index(1)
        C.set_z_index(1)
...
class CircularGeometry3(Scene):
    def construct(self):
        ...
        center1=GDom(color=RED).move_to(Circ1.get_center()).set_z_index(1)
        ...
        center2=GDom(color=RED).move_to(Circ2.get_center()).set_z_index(1)
        ...
        center3=GDom(color=RED).move_to(Circ3.get_center()).set_z_index(1)
...
class CircularGeometry5(Scene):
    def construct(self):
        ...
        self.play(Wait(0.5))
        A=GDom(color=GRAY_C,point=Plane1.c2p(7,4)).set_z_index(1)
        B=GDom(color=GRAY_C,point=Plane1.c2p(1,4)).set_z_index(1)
        t=ValueTracker(30)
        C=always_redraw(lambda: GDom(color=RED,point=Plane1.c2p(f(t.get_value()*DEGREES),g(t.get_value()*DEGREES))).set_z_index(1))
...
class CircPractice1(Scene):
    def construct(self):
        ...
        A=GDom(color=RED,point=Plane1.c2p(3,5)).set_z_index(1)
...
class CircPractice2(Scene):
    def construct(self):
        ...
        A=always_redraw(lambda: GDom(color=RED,point=Plane1.c2p(h.get_value(),k.get_value())).set_z_index(1))
...
class CircPractice4(Scene):
    def construct(self):
        ...
        A=always_redraw(lambda: GDom(color=RED,point=Plane2.c2p(3,8)).set_z_index(1))
        B=always_redraw(lambda: GDom(color=RED,point=Plane2.c2p(7,0)).set_z_index(1))
...
class CircPractice5(Scene):
    def construct(self):
        ...
        self.play(Write(Question),run_time=3.3)
        self.play(Wait(0.5))
        A=always_redraw(lambda: GDom(color=RED,point=Plane1.c2p(3,1)).set_z_index(1))
        B=always_redraw(lambda: GDom(color=RED,point=Plane1.c2p(1,-1)).set_z_index(1))
        C=always_redraw(lambda: GDom(color=RED,point=Plane1.c2p(3,-3)).set_z_index(1))
...
class CircPractice7(Scene): 
    def construct(self):
        ...
        y_label=MathTex(r"y").move_to(Plane1.c2p(-0.5,8.5)).scale(0.9)
        x_label=MathTex(r"x").move_to(Plane1.c2p(8.5,-0.5)).scale(0.9)
        AGDom=GDom(color=RED).move_to(Plane1.c2p(6,5)).set_z_index(1)
        BGDom=GDom(color=RED).move_to(Plane1.c2p(4,1)).set_z_index(1)
        CGDom=GDom(color=GRAY).move_to(Plane1.c2p(3,4)).set_z_index(1)
        ACoord=MathTex(r"A(6,5)").next_to(AGDom,RIGHT*0.5).scale(0.7).set_z_index(1)
        BCoord=MathTex(r"B(4,1)").next_to(BGDom,RIGHT*0.5).scale(0.7).set_z_index(1)
        CCoord=MathTex(r"C(h,k)").next_to(CGDom,LEFT*0.5).scale(0.7).set_z_index(1)
        Circ=always_redraw(lambda: ParametricFunction(lambda t: Plane1.c2p(f(t),g(t)),t_range=[0,2*PI],color=GRAY_BROWN))
        self.play(FadeIn(Group(y_label,x_label,background_rectangle,Plane1)))
        self.play(Write(Question),run_time=3.3)
        self.play(Write(Questionb))
        self.play(GrowFromCenter(AGDom))
        self.play(Write(ACoord))
        self.play(GrowFromCenter(BGDom))
        self.play(Write(BCoord))
        self.play(GrowFromCenter(CGDom))
        self.play(Write(CCoord))
        self.play(Wait(1))
        ...
        t[5] = MathTex(r"\Rightarrow 4h+8k=44\cGDoms\cGDoms(i)")
...
class CircPractice8(Scene):
    def construct(self):
        ...
        self.play(Wait(0.5))
        A=GDom(color=RED).move_to(circ_1.get_center()).set_z_index(1)
        B=GDom(color=RED).move_to(circ_2.get_center()).set_z_index(1)
